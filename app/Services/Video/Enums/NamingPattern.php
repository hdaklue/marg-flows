...
enum NamingPattern: string
{
    ...
    public function getDescription(): string
    {
        return match ($this) {
            self::Quality
                => 'Filename with quality suffix (e.g., video_high.mp4)',
            self::Dimension
                => 'Filename with dimensions (e.g., video_1920x1080.mp4)',
            ...
            self::Conversion
                => 'Filename with conversion name (e.g., video_4K.mp4)',
            self::Detailed
                => 'Detailed with bitrate (e.g., video_1920x1080_high_5000kbps.mp4)',
            self::Timestamped
                => 'Filename with timestamp (e.g., video_20241224123456.mp4)',
            self::Simple
                => 'Simple converted suffix (e.g., video_converted.mp4)',
            self::Resolution
                => 'Filename with resolution name (e.g., video_full_hd.mp4)',
            self::ResolutionLabel
                => 'Filename with resolution label (e.g., video_720p.mp4)',
            self::AspectRatio
                => 'Filename with aspect ratio (e.g., video_16-9.mp4)',
        };
    }
