<div wire:ignore x-load
    ...
    x-data="documentEditor(@js($content), '{{ route('documents.upload-image', ['document' => $documentId]) }}', @js($canEdit), $wire.saveDocument, 0, '{{ $this->updatedAtString }}', @js($this->getFullToolsConfig()), @js($this->getAllowedTools()))" class="w-full">
    ...
    <div x-cloak x-bind:style="isSticky ? `top: ${topbarHeight}px;` : ''"
        ...
        <div
            ...
            <div class="flex items-center space-x-1.5">
                ...
                <span class="hidden w-28 text-start text-zinc-600 sm:inline dark:text-zinc-400"
                    x-text="currentStatus.statusText"></span>
            </div>
            ...
            <div class="ml-3 flex items-center space-x-2" x-data="{
                ...
                <!-- Toggle Label -->
                <span class="hidden text-xs font-medium text-zinc-600 sm:inline dark:text-zinc-400"
