...
}" class="fixed z-50 bottom-4 right-4" @keydown.window.shift.s.prevent="show = true">
    <div class="relative">
        <div class="relative p-2 transition-all rounded-full cursor-pointer bg-zinc-400 hover:bg-zinc-300 dark:bg-zinc-600 dark:hover:bg-zinc-500"x-show="!show"
            ...
            <a x-tooltip.arrowless.raw="Sidenotes [Shift + S]" class="relative w-5 h-5">
                <div
        ...
        <div class="absolute bottom-0 right-0 h-[350px] w-[300px] rounded-lg border border-zinc-200 bg-zinc-50 p-2 shadow dark:border-zinc-700 dark:bg-zinc-800"
            ...
            <div class="flex flex-col justify-between w-full h-full cursor-normal gap-y-1">
                <header
                    class="flex items-center justify-between p-1 text-xs font-semibold text-zinc-800 dark:text-zinc-400">
                    <div>
                        <p> Side Notes</p>
                ...
                <div class="flex flex-col items-start h-full max-h-full py-1 overflow-y-auto gap-y-1">
                    @foreach ($this->notes as $note)
                        <div
                            class="relative flex flex-col w-full px-2 py-1 border rounded-lg gap-y-1 border-zinc-100 dark:border-zinc-800 dark:bg-zinc-900/50">
