<div>
    ...
    <div wire:loading wire:target="addVideo" class="w-full h-1 mb-3 rounded-full bg-zinc-200 dark:bg-zinc-700">
    ...
    <div wire:target="addVideo">
        ...
        @else
            <!-- Max videos reached -->
            <div
                class="flex items-center gap-2 p-3 border border-green-300 rounded-lg bg-green-50 dark:border-green-600 dark:bg-green-900/20">
