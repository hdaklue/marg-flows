                ...
                <div x-sortable-group id="{{ $stage->getKey() }}" data-container="{{ $stage->getKey() }}"
                    ...
                    @foreach ($todos as $todo)
                        <div x-sortable:item="{{ str()->uuid() }}" :id="$id('sortable-item')"
                            class="p-3 transition-shadow border rounded-lg cursor-move sortable-handle list-group-item group border-zinc-200 bg-zinc-50 hover:shadow-md dark:border-zinc-600 dark:bg-zinc-700"
                            ...
                            <div class="flex items-start justify-between">
                                ...
                                <div class="flex items-center space-x-2">
                                    <div x-sortable:handle
                                        class="transition-opacity opacity-0 cursor-grab active:cursor-grabbing group-hover:opacity-100"
